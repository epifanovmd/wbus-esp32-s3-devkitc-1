...
private:
    ...
    static String getStateName(uint8_t stateCode)
    {
        ...
        case 0x14:
            return "Прогрев свечи накаливания";
        case 0x15:
        ...
        case 0x20:
            return "Контроль периода простоя";
        case 0x21:
            return "Плавный пуск";
        case 0x22:
        ...
        case 0x3A:
            return "Управление циркуляционным насосом";
        case 0x3B:
        ...
        case 0x41:
            return "Процесс горения паркинг-нагрев";
        case 0x42:
            return "Процесс горения доп. нагрев";
        case 0x43:
            return "Сбой горения паркинг-нагрев";
        case 0x44:
            return "Сбой горения доп. нагрев";
        case 0x45:
            return "Выключение нагревателя после работы";
        case 0x46:
            return "Контроль простоя после работы";
        case 0x47:
            return "Послеродовая работа из-за сбоя";
        case 0x48:
            return "Временная послеродовая работа из-за сбоя";
        case 0x49:
        ...
        case 0x4D:
            return "Циркуляционный насос без функции нагрева";
        case 0x4E:
            return "Цикл ожидания перенапряжения";
        case 0x4F:
            return "Обновление памяти неисправностей";
        case 0x50:
        ...
        case 0x58:
            return "Предстарт при пониженном напряжении";
        case 0x59:
            return "Опрос аварии";
        case 0x5A:
            return "Послеродовая работа соленоидного клапана";
        case 0x5B:
            return "Обновление памяти неисправностей соленоида";
        case 0x5C:
            return "Временная послеродовая работа соленоида";
        case 0x5D:
        ...
        case 0x60:
            return "Временная послеродовая работа при пониженном напряжении";
        case 0x61:
            return "Обновление памяти неисправностей перед выключением";
        case 0x62:
            return "Рампа полной нагрузки";

        default:
            if (stateCode >= 0x63 && stateCode <= 0x7F)
    ...
    {
        // Более точные описания для конкретных состояний
        switch (stateCode)
        {
        case 0x03:
            return "Фаза продувки системы перед запуском. Подготовка камеры сгорания";
        case 0x04:
            return "Нагреватель выключен и готов к работе";
        case 0x05:
            return "Активный процесс горения с частичной нагрузкой";
        case 0x06:
            return "Активный процесс горения с полной нагрузкой";
        case 0x07:
            return "Фаза подачи топлива в камеру сгорания";
        case 0x24:
            return "Процесс запуска нагревателя";
        case 0x41:
            return "Процесс горения в режиме паркинг-нагрева";
        case 0x42:
            return "Процесс горения в режиме дополнительного нагрева";
        case 0x51:
            return "Тестирование компонентов системы";

        default:
            // Группировка по категориям
            if (stateCode >= 0x00 && stateCode <= 0x03)
                return "Фаза продувки и подготовки системы";
            if (stateCode >= 0x04 && stateCode <= 0x06)
            ...
            if (stateCode >= 0x24 && stateCode <= 0x27)
                return "Процесс запуска системы";
